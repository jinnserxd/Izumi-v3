...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~73G73WYE",
  MENU_URL: process.env.MENU_URL || "https://i.imgur.com/Kpv53IJ.jpeg",
  CAPTION: process.env.CAPTION || "ᴊɪɴɴ ꜱᴇʀ xᴅ",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || "ᴊɪɴɴ ꜱᴇʀ",
  BOT_NAME: process.env.BOT_NAME || "ᴊɪɴɴ ꜱᴇʀ",
