...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "izumi~MP9mGuiu",
  MENU_URL: process.env.MENU_URL || "https://i.imgur.com/Kpv53IJ.jpeg",
  CAPTION: process.env.CAPTION || "Iᴢᴜᴍɪ",
  READ_MSG: toBool(process.env.READ_MSG),
  OWNER_NAME: process.env.OWNER_NAME || " 𝚭𝚫𝚪𝚫 𝚾𝐃",
  BOT_NAME: process.env.BOT_NAME || " 𝚭𝚫𝚪𝚫 𝚾𝐃",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || " 𝚭𝚫𝚪𝚫 𝚾𝐃 " 
      ",
